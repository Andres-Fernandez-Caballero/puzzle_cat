...
import { estaresuelto, mezclarfichas, mover, puedomover } from '../utils/FuncionesFichas'
...
export const TableroV2 = (props) => {
    ...
    return (
        ...
        <div style={{textAlign:"center", marginTop: '2rem'}}>
            <button className="btn" onClick={mezclar}>mezclar</button>
        </div>
